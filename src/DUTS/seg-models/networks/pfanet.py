# Code borrowed from https://github.com/sairajk/PyTorch-Pyramid-Feature-Attention-Network-for-Saliency-Detection
# ------------------------------------------------------------------------------------------------
# pfanet.py : Pyramid feature Attention Network architecture for DUTS saliency detection dataset.

# Usage: python src/DUTS/seg-models/networks/pfanet.py

# Note: To independently run the model, always run this file from ThreshNetRefinement (root) directory.
# -----------------------------------------------------------------------------------------------------------------------
