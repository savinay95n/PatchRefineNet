...
# Usage: python src/DUTS/refine-models/predict.py --base_model pfanet --aux_model p64 --checkpoint True
...
logging.info('==========================================================================================')
logging.info('Predicting %s aux model on DUTS dataset trained on base model %s', args.aux_model, args.base_model)
logging.info('==========================================================================================')
