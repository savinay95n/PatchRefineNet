# -----------------------------------------------------------------------------------------------------------------------
# train.py: This is the code to train base segmentation network on deepglobe dataset.

# Usage: python src/deepglobe/seg-models/train.py --model dlinknet
...
# Log directory
LOG_DIR = os.path.join(WORKING_DIR, 'src', 'deepglobe', 'seg-models', 'logs', args.model)
# Checkpoint directory
CHECKPOINT_DIR = os.path.join(WORKING_DIR, 'src', 'deepglobe', 'seg-models', 'checkpoints', args.model)
# Output directory
OUTPUT_DIR = os.path.join(WORKING_DIR, 'src', 'deepglobe', 'seg-models', 'outputs', args.model)
# log file name
...
trainlist = list(map(lambda x: x[:-8], train_dataframe))
